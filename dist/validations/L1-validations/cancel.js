...
exports.validateCancel = validateCancel;
...
function validate_attribute_14(payload, externalData = {}) {
    ...
    for (const testObj of scope) {
        testObj._EXTERNAL = externalData;
        const attr = payload_utils_1.default.getJsonPath(testObj, "$.message.order_id");
        const nulls = ["null"];
        const skipCheck = false;
        if (skipCheck)
            continue;
...
function validate_attribute_15(payload, externalData = {}) {
    ...
    for (const testObj of scope) {
        testObj._EXTERNAL = externalData;
        const attr = payload_utils_1.default.getJsonPath(testObj, "$.message.cancellation_reason_id");
        const nulls = ["null"];
        const skipCheck = false;
        if (skipCheck)
            continue;
...
function validate_attribute_16(payload, externalData = {}) {
    ...
    for (const testObj of scope) {
        testObj._EXTERNAL = externalData;
        const attr = payload_utils_1.default.getJsonPath(testObj, "$.message.descriptor.code");
        const nulls = ["null"];
        const skipCheck = false;
        if (skipCheck)
            continue;
...
function validate_attribute_17(payload, externalData = {}) {
    ...
    for (const testObj of scope) {
        testObj._EXTERNAL = externalData;
        const attr = payload_utils_1.default.getJsonPath(testObj, "$.message.descriptor.name");
        const nulls = ["null"];
        const skipCheck = false;
        if (skipCheck)
            continue;
...
function validate_enum_5(payload, externalData = {}) {
    ...
    for (const testObj of scope) {
        ...
        const enumPath = payload_utils_1.default.getJsonPath(testObj, "$.message.descriptor.code");
        const skipCheck = false;
        if (skipCheck)
            continue;
        const output = validation_utils_1.default.ALL_IN(enumPath, enumList);
...
function validateCancel(payload, externalData = {}) {

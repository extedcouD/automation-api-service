                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_46_FULFILLMENTS_TYPE**: every element of $.message.order.fulfillments[*].stops[*].type must be in ["START", "END", "INTERMEDIATE_STOP", "TRANSIT_STOP"]

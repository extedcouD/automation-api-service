...
export default function on_init(input: validationInput): validationOutput {
    ...
    for (const testObj of scope) {
        ...
        function Enum_Required_34_CONTEXT_ACTION(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_34_CONTEXT_ACTION**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_34_CONTEXT_ACTION.2**: $.context.action must be present in the payload`,
        ...
        function Enum_Required_35_COUNTRY_CODE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_35_COUNTRY_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_35_COUNTRY_CODE.2**: $.context.location.country.code must be present in the payload`,
        ...
        function Enum_Required_36_CITY_CODE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_36_CITY_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_36_CITY_CODE.2**: $.context.location.city.code must be present in the payload`,
        ...
        function Enum_Required_37_CONTEXT_DOMAIN(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_37_CONTEXT_DOMAIN**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_37_CONTEXT_DOMAIN.2**: $.context.domain must be present in the payload`,
        ...
        function on_init_Message_TESTS(
            ...
            for (const testObj of scope) {
                ...
                function Attri_Required_25_PAYMENTS_ID(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_25_PAYMENTS_ID**: $.message.order.payments[*].id must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_26_ITEMS_CATEGORY_IDS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_26_ITEMS_CATEGORY_IDS**: $.message.order.items[*].category_ids[*] must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_27_RANGE_START(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_27_RANGE_START**: $.message.order.provider.time.range.start must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_28_RANGE_END(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_28_RANGE_END**: $.message.order.provider.time.range.end must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_29_SELECTED_COUNT(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_29_SELECTED_COUNT**: $.message.order.quote.breakup[*].item.quantity.selected.count must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_30_PRICE_VALUE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_30_PRICE_VALUE**: $.message.order.quote.breakup[*].item.price.value must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_31_PRICE_CURRENCY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_31_PRICE_CURRENCY**: $.message.order.quote.breakup[*].item.price.currency must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_32_EXTERNAL_REF_URL(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_32_EXTERNAL_REF_URL**: $.message.order.cancellation_terms[*].external_ref.url must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_33_EXTERNAL_REF_MIMETYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_33_EXTERNAL_REF_MIMETYPE**: $.message.order.cancellation_terms[*].external_ref.mimetype must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Enum_Required_38_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_38_DESCRIPTOR_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_38_DESCRIPTOR_CODE.2**: $.message.order.items[*].descriptor.code must be present in the payload`,
                ...
                function Enum_Required_39_VEHICLE_CATEGORY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_39_VEHICLE_CATEGORY**: all of the following sub conditions must be met:
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_40_FULFILLMENTS_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_40_FULFILLMENTS_TYPE.2**: $.message.order.fulfillments[*].type must be present in the payload`,
                ...
                function Enum_Required_41_FULFILLMENTS_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_41_FULFILLMENTS_TYPE**: every element of $.message.order.fulfillments[*].stops[*].type must be in ["START", "END", "INTERMEDIATE_STOP", "TRANSIT_STOP"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].type must **not** be present in the payload`,
                ...
                function Enum_Required_42_AUTHORIZATION_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_42_AUTHORIZATION_TYPE**: every element of $.message.order.fulfillments[*].stops[*].authorization.type must be in ["QR"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].authorization.type must **not** be present in the payload`,
                ...
                function Enum_Required_43_AUTHORIZATION_STATUS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_43_AUTHORIZATION_STATUS**: every element of $.message.order.fulfillments[*].stops[*].authorization.status must be in ["UNCLAIMED", "CLAIMED"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].authorization.status must **not** be present in the payload`,
                ...
                function Enum_Required_44_PAYMENTS_STATUS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_44_PAYMENTS_STATUS**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_44_PAYMENTS_STATUS.2**: $.message.order.payments[*].status must be present in the payload`,
                ...
                function Enum_Required_45_PAYMENTS_COLLECTED_BY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_45_PAYMENTS_COLLECTED_BY**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_45_PAYMENTS_COLLECTED_BY.2**: $.message.order.payments[*].collected_by must be present in the payload`,
                ...
                function Enum_Required_46_PAYMENTS_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_46_PAYMENTS_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_46_PAYMENTS_TYPE.2**: $.message.order.payments[*].type must be present in the payload`,
                ...
                function Enum_Required_47_BREAKUP_TITLE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_47_BREAKUP_TITLE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_47_BREAKUP_TITLE.2**: $.message.order.quote.breakup[*].title must be present in the payload`,
                ...
                function ROUTE_INFO_Tag_Required_48_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition ROUTE_INFO_Tag_Required_48_DESCRIPTOR_CODE**: every element of $.message.order.fulfillments[*].tags[*].descriptor.code must be in ["ROUTE_INFO", "TICKET_INFO", "TRIP_DETAILS"]
	...
	> - **condition B**: $.message.order.fulfillments[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                function FARE_POLICY_Tag_Required_52_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition FARE_POLICY_Tag_Required_52_DESCRIPTOR_CODE**: every element of $.message.order.items[*].tags[*].descriptor.code must be in ["FARE_POLICY"]
	...
	> - **condition B**: $.message.order.items[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                function BUYER_FINDER_FEES_Tag_Required_54_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition BUYER_FINDER_FEES_Tag_Required_54_DESCRIPTOR_CODE**: every element of $.message.order.payments[*].tags[*].descriptor.code must be in ["BUYER_FINDER_FEES", "SETTLEMENT_TERMS"]
	...
	> - **condition B**: $.message.order.payments[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                const testFunctions: testFunctionArray = [
                    ...
                    Attri_Required_25_PAYMENTS_ID,
                    Attri_Required_26_ITEMS_CATEGORY_IDS,
                    Attri_Required_27_RANGE_START,
                    Attri_Required_28_RANGE_END,
                    Attri_Required_29_SELECTED_COUNT,
                    Attri_Required_30_PRICE_VALUE,
                    Attri_Required_31_PRICE_CURRENCY,
                    Attri_Required_32_EXTERNAL_REF_URL,
                    Attri_Required_33_EXTERNAL_REF_MIMETYPE,
                    Enum_Required_38_DESCRIPTOR_CODE,
                    Enum_Required_39_VEHICLE_CATEGORY,
                    Enum_Required_40_FULFILLMENTS_TYPE,
                    Enum_Required_41_FULFILLMENTS_TYPE,
                    Enum_Required_42_AUTHORIZATION_TYPE,
                    Enum_Required_43_AUTHORIZATION_STATUS,
                    Enum_Required_44_PAYMENTS_STATUS,
                    Enum_Required_45_PAYMENTS_COLLECTED_BY,
                    Enum_Required_46_PAYMENTS_TYPE,
                    Enum_Required_47_BREAKUP_TITLE,
                    ROUTE_INFO_Tag_Required_48_DESCRIPTOR_CODE,
                    validate_tag_0_ROUTE_INFO,
                    validate_tag_0_TICKET_INFO,
                    validate_tag_0_TRIP_DETAILS,
                    FARE_POLICY_Tag_Required_52_DESCRIPTOR_CODE,
                    validate_tag_1_FARE_POLICY,
                    BUYER_FINDER_FEES_Tag_Required_54_DESCRIPTOR_CODE,
        ...
        const testFunctions: testFunctionArray = [
            ...
            Enum_Required_34_CONTEXT_ACTION,
            Enum_Required_35_COUNTRY_CODE,
            Enum_Required_36_CITY_CODE,
            Enum_Required_37_CONTEXT_DOMAIN,

...
export default function on_cancel(input: validationInput): validationOutput {
    ...
    for (const testObj of scope) {
        ...
        function Enum_Required_38_CONTEXT_ACTION(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_38_CONTEXT_ACTION**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_38_CONTEXT_ACTION.2**: $.context.action must be present in the payload`,
        ...
        function Enum_Required_39_COUNTRY_CODE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_39_COUNTRY_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_39_COUNTRY_CODE.2**: $.context.location.country.code must be present in the payload`,
        ...
        function Enum_Required_40_CITY_CODE(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_40_CITY_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_40_CITY_CODE.2**: $.context.location.city.code must be present in the payload`,
        ...
        function Enum_Required_41_CONTEXT_DOMAIN(
            input: validationInput,
        ): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition Enum_Required_41_CONTEXT_DOMAIN**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_41_CONTEXT_DOMAIN.2**: $.context.domain must be present in the payload`,
        ...
        function on_cancel_Message_TESTS(
            ...
            for (const testObj of scope) {
                ...
                function Attri_Required_18_ITEMS_CATEGORY_IDS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_18_ITEMS_CATEGORY_IDS**: $.message.order.items[*].category_ids[*] must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_19_TIME_LABEL(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_19_TIME_LABEL**: $.message.order.items[*].time.label must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_20_TIME_DURATION(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_20_TIME_DURATION**: $.message.order.items[*].time.duration must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_21_PROVIDER_ID(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_21_PROVIDER_ID**: $.message.order.provider.id must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_22_DESCRIPTOR_NAME(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_22_DESCRIPTOR_NAME**: $.message.order.provider.descriptor.name must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_23_IMAGES_URL(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_23_IMAGES_URL**: $.message.order.provider.descriptor.images[*].url must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_24_RANGE_START(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_24_RANGE_START**: $.message.order.provider.time.range.start must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_25_RANGE_END(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_25_RANGE_END**: $.message.order.provider.time.range.end must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_26_FULFILLMENTS_ID(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_26_FULFILLMENTS_ID**: $.message.order.fulfillments[*].id must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_27_FULFILLMENTS_ID(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_27_FULFILLMENTS_ID**: $.message.order.fulfillments[*].id must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_28_LOCATION_GPS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_28_LOCATION_GPS**: $.message.order.fulfillments[*].stops[*].location.gps must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_31_PAYMENTS_ID(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_31_PAYMENTS_ID**: $.message.order.payments[*].id must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_32_PARAMS_BANK_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_32_PARAMS_BANK_CODE**: $.message.order.payments[*].params.bank_code must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_33_PARAMS_BANK_ACCOUNT_NUMBER(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_33_PARAMS_BANK_ACCOUNT_NUMBER**: $.message.order.payments[*].params.bank_account_number must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_34_EXTERNAL_REF_URL(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_34_EXTERNAL_REF_URL**: $.message.order.cancellation_terms[*].external_ref.url must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_35_EXTERNAL_REF_MIMETYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_35_EXTERNAL_REF_MIMETYPE**: $.message.order.cancellation_terms[*].external_ref.mimetype must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_36_CANCELLATION_CANCELLED_BY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_36_CANCELLATION_CANCELLED_BY**: $.message.order.cancellation.cancelled_by must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Attri_Required_37_CANCELLATION_TIME(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Attri_Required_37_CANCELLATION_TIME**: $.message.order.cancellation.time must be present in the payload`,
                                },
                            ];
                        }
                ...
                function Enum_Required_42_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_42_DESCRIPTOR_CODE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_42_DESCRIPTOR_CODE.2**: $.message.order.items[*].descriptor.code must be present in the payload`,
                ...
                function Enum_Required_43_VEHICLE_CATEGORY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_43_VEHICLE_CATEGORY**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_43_VEHICLE_CATEGORY.2**: $.message.order.fulfillments[*].vehicle.category must be present in the payload`,
                ...
                function Enum_Required_44_FULFILLMENTS_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_44_FULFILLMENTS_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_44_FULFILLMENTS_TYPE.2**: $.message.order.fulfillments[*].type must be present in the payload`,
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_45_FULFILLMENTS_TYPE**: every element of $.message.order.fulfillments[*].stops[*].type must be in ["START", "END", "INTERMEDIATE_STOP", "TRANSIT_STOP"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].type must **not** be present in the payload`,
                ...
                function Enum_Required_46_AUTHORIZATION_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_46_AUTHORIZATION_TYPE**: every element of $.message.order.fulfillments[*].stops[*].authorization.type must be in ["QR"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].authorization.type must **not** be present in the payload`,
                ...
                function Enum_Required_47_AUTHORIZATION_STATUS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_47_AUTHORIZATION_STATUS**: every element of $.message.order.fulfillments[*].stops[*].authorization.status must be in ["UNCLAIMED", "CLAIMED"]
	...
	> - **condition B**: $.message.order.fulfillments[*].stops[*].authorization.status must **not** be present in the payload`,
                ...
                function Enum_Required_48_PAYMENTS_STATUS(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_48_PAYMENTS_STATUS**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_48_PAYMENTS_STATUS.2**: $.message.order.payments[*].status must be present in the payload`,
                ...
                function Enum_Required_49_PAYMENTS_COLLECTED_BY(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_49_PAYMENTS_COLLECTED_BY**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_49_PAYMENTS_COLLECTED_BY.2**: $.message.order.payments[*].collected_by must be present in the payload`,
                ...
                function Enum_Required_50_PAYMENTS_TYPE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_50_PAYMENTS_TYPE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_50_PAYMENTS_TYPE.2**: $.message.order.payments[*].type must be present in the payload`,
                ...
                function Enum_Required_51_BREAKUP_TITLE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition Enum_Required_51_BREAKUP_TITLE**: all of the following sub conditions must be met:
  ...
  - **condition Enum_Required_51_BREAKUP_TITLE.2**: $.message.order.quote.breakup[*].title must be present in the payload`,
                ...
                function ROUTE_INFO_Tag_Required_52_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition ROUTE_INFO_Tag_Required_52_DESCRIPTOR_CODE**: every element of $.message.order.fulfillments[*].tags[*].descriptor.code must be in ["ROUTE_INFO", "TICKET_INFO", "TRIP_DETAILS"]
	...
	> - **condition B**: $.message.order.fulfillments[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                function FARE_POLICY_Tag_Required_56_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition FARE_POLICY_Tag_Required_56_DESCRIPTOR_CODE**: every element of $.message.order.items[*].tags[*].descriptor.code must be in ["FARE_POLICY"]
	...
	> - **condition B**: $.message.order.items[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                function BUYER_FINDER_FEES_Tag_Required_58_DESCRIPTOR_CODE(
                    input: validationInput,
                ): validationOutput {
                    const scope = payloadUtils.getJsonPath(input.payload, "$");
                    let subResults: validationOutput = [];
                            ...
                            return [
                                {
                                    valid: false,
                                    code: 30000,
                                    description: `- **condition BUYER_FINDER_FEES_Tag_Required_58_DESCRIPTOR_CODE**: every element of $.message.order.payments[*].tags[*].descriptor.code must be in ["BUYER_FINDER_FEES", "SETTLEMENT_TERMS"]
	...
	> - **condition B**: $.message.order.payments[*].tags[*].descriptor.code must **not** be present in the payload`,
                ...
                const testFunctions: testFunctionArray = [
                    ...
                    Attri_Required_18_ITEMS_CATEGORY_IDS,
                    Attri_Required_19_TIME_LABEL,
                    Attri_Required_20_TIME_DURATION,
                    Attri_Required_21_PROVIDER_ID,
                    Attri_Required_22_DESCRIPTOR_NAME,
                    Attri_Required_23_IMAGES_URL,
                    Attri_Required_24_RANGE_START,
                    Attri_Required_25_RANGE_END,
                    Attri_Required_26_FULFILLMENTS_ID,
                    Attri_Required_27_FULFILLMENTS_ID,
                    Attri_Required_28_LOCATION_GPS,
                    Attri_Required_29_PRICE_VALUE,
                    Attri_Required_30_PRICE_CURRENCY,
                    Attri_Required_31_PAYMENTS_ID,
                    Attri_Required_32_PARAMS_BANK_CODE,
                    Attri_Required_33_PARAMS_BANK_ACCOUNT_NUMBER,
                    Attri_Required_34_EXTERNAL_REF_URL,
                    Attri_Required_35_EXTERNAL_REF_MIMETYPE,
                    Attri_Required_36_CANCELLATION_CANCELLED_BY,
                    Attri_Required_37_CANCELLATION_TIME,
                    Enum_Required_42_DESCRIPTOR_CODE,
                    Enum_Required_43_VEHICLE_CATEGORY,
                    Enum_Required_44_FULFILLMENTS_TYPE,
                    Enum_Required_45_FULFILLMENTS_TYPE,
                    Enum_Required_46_AUTHORIZATION_TYPE,
                    Enum_Required_47_AUTHORIZATION_STATUS,
                    Enum_Required_48_PAYMENTS_STATUS,
                    Enum_Required_49_PAYMENTS_COLLECTED_BY,
                    Enum_Required_50_PAYMENTS_TYPE,
                    Enum_Required_51_BREAKUP_TITLE,
                    ROUTE_INFO_Tag_Required_52_DESCRIPTOR_CODE,
                    validate_tag_0_ROUTE_INFO,
                    validate_tag_0_TICKET_INFO,
                    validate_tag_0_TRIP_DETAILS,
                    FARE_POLICY_Tag_Required_56_DESCRIPTOR_CODE,
                    validate_tag_1_FARE_POLICY,
                    BUYER_FINDER_FEES_Tag_Required_58_DESCRIPTOR_CODE,
        ...
        const testFunctions: testFunctionArray = [
            ...
            Enum_Required_38_CONTEXT_ACTION,
            Enum_Required_39_COUNTRY_CODE,
            Enum_Required_40_CITY_CODE,
            Enum_Required_41_CONTEXT_DOMAIN,

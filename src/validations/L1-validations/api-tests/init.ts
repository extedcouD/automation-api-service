                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_collected_by_16**: $.message.order.payments[*].collected_by must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_status_17**: $.message.order.payments[*].status must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_type_18**: $.message.order.payments[*].type must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_1**: every element of $.context.action must be in ["init"]
